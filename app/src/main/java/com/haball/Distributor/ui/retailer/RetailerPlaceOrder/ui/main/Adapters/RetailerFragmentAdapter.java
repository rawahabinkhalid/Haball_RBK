...
public class RetailerFragmentAdapter extends RecyclerView.Adapter<RetailerFragmentAdapter.ViewHolder> {
    ...
    public RetailerFragmentAdapter(Context context, List<Retailer_Fragment_Model> retailerList, ViewPager mPager) {
    ...
    @Override
    public RetailerFragmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view_inflate = LayoutInflater.from(context).inflate(R.layout.company_fragment,parent,false);
        return new RetailerFragmentAdapter.ViewHolder(view_inflate);
    }


    @Override
    public void onBindViewHolder(@NonNull RetailerFragmentAdapter.ViewHolder holder, final int position) {
//
        if(retailerList.get(position).getName() != null)
            heading = retailerList.get(position).getName();
...
//            status = orderList.get(position).getOrderStatusValue();
        ...
        holder.ll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.putString("CompanyId", retailerList.get(position).getId());
                editor.commit();
