 ...
 */
public class SectionsPagerAdapter_Only_Dashboard extends FragmentPagerAdapter {
...
//    private static final int[] TAB_TITLES = new int[]{R.string.tab_retailer_order};
    ...
    public SectionsPagerAdapter_Only_Dashboard(Context context, FragmentManager fm) {
        super(fm);
        mContext = context;
    }
