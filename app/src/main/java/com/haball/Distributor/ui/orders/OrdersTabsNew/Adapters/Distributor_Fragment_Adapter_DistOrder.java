...
public class Distributor_Fragment_Adapter_DistOrder extends RecyclerView.Adapter<Distributor_Fragment_Adapter_DistOrder.ViewHolder> {
    ...
    public Distributor_Fragment_Adapter_DistOrder(Context context, List<Distributor_Fragment_Model_DistOrder> companyList, ViewPager mPager) {
    ...
    @Override
    public Distributor_Fragment_Adapter_DistOrder.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view_inflate = LayoutInflater.from(context).inflate(R.layout.company_fragment,parent,false);
        return new Distributor_Fragment_Adapter_DistOrder.ViewHolder(view_inflate);
    }


    @Override
    public void onBindViewHolder(@NonNull Distributor_Fragment_Adapter_DistOrder.ViewHolder holder, final int position) {
//
