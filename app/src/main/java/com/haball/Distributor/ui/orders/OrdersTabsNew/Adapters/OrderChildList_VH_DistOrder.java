...
public class OrderChildList_VH_DistOrder extends ChildViewHolder {
    TextView product_code, discount, UOM, list_txt_products, list_product_code_value, list_price_value, list_discount_value, list_UOM_value, list_Quantity_value, list_amount_value;
