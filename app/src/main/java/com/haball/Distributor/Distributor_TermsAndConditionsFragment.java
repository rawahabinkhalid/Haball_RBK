...
public class Distributor_TermsAndConditionsFragment extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String htmlText = " %s ";
        String myData = "<html><head><link href=\"https://fonts.googleapis.com/css?family=Open+Sans:300,400,700\" rel=\"stylesheet\"><style>ol {\n" +
                "    counter-reset: item;\n" +
                "}\n" +
                "\n" +
                "ol > li {\n" +
        ...
        loader = new Loader(Distributor_TermsAndConditionsFragment.this);
        ...
        disagree_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Distributor_TermsAndConditionsFragment.this, Distribution_Login.class);
    ...
    private void termsAndConditionAccepted() throws JSONException {
        ...
        BooleanRequest sr = new BooleanRequest(Request.Method.POST, URL, requestBody, new Response.Listener<Boolean>() {
            ...
            public void onResponse(Boolean result) {
                loader.hideLoader();
                if (result) {
                    Intent intent = new Intent(Distributor_TermsAndConditionsFragment.this, Distributor_UpdatePassword.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(Distributor_TermsAndConditionsFragment.this, "Error occurred.", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Distributor_TermsAndConditionsFragment.this, Distribution_Login.class);
                    startActivity(intent);
                    finish();
                }
            ...
            public void onErrorResponse(VolleyError error) {
                loader.hideLoader();
                new ProcessingError().showError(Distributor_TermsAndConditionsFragment.this);
